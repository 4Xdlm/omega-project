 ...
 */
import { ContextScope, ElementType, ElementState } from './constants.js';
...
export declare function comparePositions(a: TextPosition, b: TextPosition): number;
...
export declare enum ContextAction {
    MOVE = "MOVE",
...
/** Codes d'erreur */
export declare enum ContextErrorCode {
