 ...
 */
import { ConflictCategory, ConflictSeverity, ConflictStatus, ResolutionStrategy, ConflictFlag } from './constants.js';
...
/** Codes d'erreur */
export declare enum ResolverErrorCode {
