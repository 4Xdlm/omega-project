...
**Version** : V1.3-RC1 CLEAN (Release Candidate 1 — Artefact intégrité validée)
**Date** : 2026-05-28
**Status** : `DRAFT_PENDING_FINAL_TRIBUNAL_VALIDATION`
...
- **≥10 hallucinations IA documentées** (7 v1.2 + 3 v1.3)
...
- **4 piliers v1.1** maintenus intacts + **1 pilier v1.2** (Cimetière) + **enrichissement v1.3-RC1 (≥10 hallu)**
