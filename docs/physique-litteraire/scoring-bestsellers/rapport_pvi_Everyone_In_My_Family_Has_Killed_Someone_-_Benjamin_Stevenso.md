...
| T | 0.5494 | proxy(1-DR) | >= 0.75 | GOULOT |
...
E_emo = 0.7149 | E_cog = 0.2067 | CE = 3.4583

R = 0.6400 | W = 0.6941 | Arc_rev = 1.20

Score etouffement FL x (1-Omega) = 0.0337

**PVI = 1.7192 | SP = 34.4/100**

## VERDICT

**Phase 4 : best-seller organique**

**Probabilite bestseller : 78.6% -> PASS — potentiel bestseller detecte**
...
1. **FL** -0.10 -> PVI +0.5501 (+32.0%)
2. **I** +0.10 -> PVI +0.3154 (+18.3%)
3. **Omega** +0.10 -> PVI +0.1740 (+10.1%)
...
| I | 0.8107 | 0.65 | OK | OK |
| T_proxy | 0.5494 | 0.75 | **-0.20** | MANQUE |
