...
E_emo = 0.3014 | E_cog = 0.3000 | CE = 1.0047

R = 0.2839 | W = 0.3440 | Arc_rev = 1.00

Score etouffement FL x (1-Omega) = 0.0848 **ATTENTION: > 0.08 — risque abandon lecteur**

**PVI = 0.0815 | SP = 1.6/100**

## VERDICT

**Phase 1 : mort organique**

**Probabilite bestseller : 30.3% -> FAIL — pas de potentiel bestseller intrinseque**

## GOULOTS ACTIFS

- **GOULOT-I** : Protagoniste insuffisamment identifiable (actuel=0.11, seuil=0.55)
- **GOULOT-R** : Lecteur n'atteint probablement pas la fin (actuel=0.28, seuil=0.5)
- **GOULOT-W** : Transmissibilite nulle (actuel=0.34, seuil=0.5)

## TOP 3 LEVIERS

1. **I** +0.10 -> PVI +0.0352 (+43.2%)
2. **FL** -0.10 -> PVI +0.0206 (+25.3%)
3. **Omega** +0.10 -> PVI +0.0177 (+21.7%)
...
| MS | 0.8210 | 0.85 | **-0.03** | MANQUE |
| Omega | 0.7200 | 0.72 | OK | OK |
| I | 0.1081 | 0.65 | **-0.54** | MANQUE |
