...
E_emo = 0.3751 | E_cog = 0.2637 | CE = 1.4225

R = 0.3337 | W = 0.3532 | Arc_rev = 1.00

Score etouffement FL x (1-Omega) = 0.0780

**PVI = 0.1415 | SP = 2.8/100**

## VERDICT

**Phase 1 : mort organique**

**Probabilite bestseller : 34.5% -> FAIL — pas de potentiel bestseller intrinseque**

## GOULOTS ACTIFS

- **GOULOT-I** : Protagoniste insuffisamment identifiable (actuel=0.13, seuil=0.55)
- **GOULOT-R** : Lecteur n'atteint probablement pas la fin (actuel=0.33, seuil=0.5)
- **GOULOT-W** : Transmissibilite nulle (actuel=0.35, seuil=0.5)

## TOP 3 LEVIERS

1. **I** +0.10 -> PVI +0.0553 (+39.1%)
2. **FL** -0.10 -> PVI +0.0391 (+27.6%)
3. **Omega** +0.10 -> PVI +0.0294 (+20.8%)
