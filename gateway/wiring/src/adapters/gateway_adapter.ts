...
export class GatewayAdapter {
  ...
  build(rawInput: unknown, context: GatewayRequestContext): NexusResult<EnvelopeBuildResult> {
    ...
    const envelope = buildEnvelope({
      ...
      ...(context.parent_span_id !== undefined && { parent_span_id: context.parent_span_id }),
      ...
      ...(context.auth_context !== undefined && { auth_context: context.auth_context }),
      ...(context.expected_previous_hash !== undefined && { expected_previous_hash: context.expected_previous_hash }),
