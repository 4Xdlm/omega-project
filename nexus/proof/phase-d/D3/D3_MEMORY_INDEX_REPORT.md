...
- **Index files exist**: PASS (4 files)
- **Test file exists**: PASS (tests/memory/index.test.ts)
- **Rebuild determinism**: PASS (hash unchanged, 3 entries)
- **Index exports**: PASS (buildIndex, OffsetMapBuilder exported)
