/**
 * OMEGA Genesis Planner — Test Fixtures
 * Phase C.1 — 3 scenarios: A (medium), B (minimal), C (hostile/XL)
 */

import type { Intent, Canon, Constraints, StyleGenomeInput, EmotionTarget } from '../src/types.js';
