...
export type StageHandler<TInput, TOutput> = (input: TInput, context: StageContext) => Promise<TOutput>;
...
export type PipelineEventType = "pipeline:start" | "pipeline:complete" | "pipeline:error" | "stage:start" | "stage:complete" | "stage:error" | "stage:retry";
