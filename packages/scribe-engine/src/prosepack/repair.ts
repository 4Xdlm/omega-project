      ...
      for (let attempt = 1; attempt <= MAX_REPAIR_ATTEMPTS; attempt++) {
        ...
        if (validation.pass) {
          ...
          const repairedScene: ProsePackScene = {
            ...
            pov_detected: analysis.pov_detected,
            tense_detected: analysis.tense_detected,
        ...
        if (origBump.bumped) {
          ...
          if (bumpedHard.length === 0) {
            const bumpedScene: ProsePackScene = {
              ...
              pov_detected: bumpedAnalysis.pov_detected,
              tense_detected: bumpedAnalysis.tense_detected,
