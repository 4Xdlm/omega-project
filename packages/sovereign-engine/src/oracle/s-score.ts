 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 *
 * @deprecated TERMINAL — Ne contient plus que computeSScore (legacy V1 9-axis).
 ...
 * @see src/oracle/macro-axes.ts — Calcul des 5 macro-axes + computeMacroSScore
 * @see src/oracle/macro-score-types.ts — Interface MacroSScore
 *
