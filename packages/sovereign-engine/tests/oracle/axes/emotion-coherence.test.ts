...
describe('scoreEmotionCoherence', () => {
  it('transitions smoothes entre paragraphes → score élevé', () => {
...
Elle ouvrit la porte avec précaution.`;
    ...
    const result = scoreEmotionCoherence(mockPacket as ForgePacket, textSmooth);
  ...
  it('sauts brutaux entre paragraphes → score bas', () => {
...
La rage explosive la consumait entièrement.`;
    ...
    const result = scoreEmotionCoherence(mockPacket as ForgePacket, textBrutal);
  ...
  it('texte très court (1 paragraphe) → score par défaut', () => {
    const textShort = 'Elle marchait.';
    const result = scoreEmotionCoherence(mockPacket as ForgePacket, textShort);
...
Elle sentait son cœur accélérer.`;
    ...
    const score1 = scoreEmotionCoherence(mockPacket as ForgePacket, text);
    const score2 = scoreEmotionCoherence(mockPacket as ForgePacket, text);
    const score3 = scoreEmotionCoherence(mockPacket as ForgePacket, text);
