...
$out = "OMEGA - PIERRE DE ROSETTE - DRY-RUN S1`r`n"
$out += "Extrait : Claude Simon - La Route des Flandres - APEX`r`n"
$out += "Date    : $ts`r`n"
$out += "Model   : $MODEL`r`n"
$out += "======================================================`r`n`r`n"
