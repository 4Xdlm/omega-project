...
const INVENTORY_RAW: InvariantRecord[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // MODULE: genome (added Sprint 28.5 — Genome Integration)
  // ─────────────────────────────────────────────────────────────────────────
  {
    id: 'INV-GEN-01',
    module: 'genome',
    category: 'PURE',
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/genome.test.ts' },
    rationale: 'Determinism: same input + seed = same fingerprint'
  },
  {
    id: 'INV-GEN-02',
    module: 'genome',
    category: 'PURE',
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/canonical.test.ts' },
    rationale: 'Fingerprint = SHA256(canonicalBytes(payloadSansMetadata))'
  },
  {
    id: 'INV-GEN-03',
    module: 'genome',
    category: 'PURE',
    criticality: 'HIGH',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/validation.test.ts' },
    rationale: 'All axes bounded [0,1] or [-1,1] for valence'
  },
  {
    id: 'INV-GEN-04',
    module: 'genome',
    ...
    criticality: 'HIGH',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/validation.test.ts' },
    rationale: 'Emotion distribution sums to 1.0 (tolerance 0.001)'
  },
  {
    id: 'INV-GEN-05',
    module: 'genome',
    ...
    criticality: 'HIGH',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/validation.test.ts' },
    rationale: 'Similarity symmetric: sim(A,B) = sim(B,A)'
  },
  {
    id: 'INV-GEN-06',
    module: 'genome',
    ...
    criticality: 'HIGH',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/validation.test.ts' },
    rationale: 'Similarity bounded [0,1]'
  },
  {
    id: 'INV-GEN-07',
    module: 'genome',
    ...
    criticality: 'MEDIUM',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/validation.test.ts' },
    rationale: 'Self-similarity: sim(A,A) = 1.0 exactly'
  },
  {
    id: 'INV-GEN-08',
    module: 'genome',
    ...
    criticality: 'MEDIUM',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/genome.test.ts' },
    rationale: 'Version field matches GENOME_VERSION constant'
  },
  {
    id: 'INV-GEN-09',
    module: 'genome',
    ...
    criticality: 'HIGH',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/genome.test.ts' },
    rationale: 'SourceHash traces back to original rootHash'
  },
  {
    id: 'INV-GEN-10',
    module: 'genome',
    ...
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/genome.test.ts' },
    rationale: 'Read-only: extraction does not modify source'
  },
  {
    id: 'INV-GEN-11',
    module: 'genome',
    ...
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/canonical.test.ts' },
    rationale: 'Metadata excluded from fingerprint computation'
  },
  {
    id: 'INV-GEN-12',
    module: 'genome',
    ...
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/validation.test.ts' },
    rationale: 'Emotion14 sanctuarized: 14 emotions, alphabetic order'
  },
  {
    id: 'INV-GEN-13',
    module: 'genome',
    ...
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/canonical.test.ts' },
    rationale: 'Canonical serialization: sorted keys, UTF-8, no whitespace'
  },
  {
    id: 'INV-GEN-14',
    module: 'genome',
    ...
    criticality: 'CRITICAL',
    source: { kind: 'TEST', ref: 'packages/genome/test/invariants/canonical.test.ts' },
    rationale: 'Float quantization 1e-6 before hash (6 decimals)'
  },
...
export const DISCOVERY_EXCLUSIONS = Object.freeze([
  ...
  'INV-GEN-01',        // Genome: Determinism
  'INV-GEN-02',        // Genome: Fingerprint SHA256
  'INV-GEN-03',        // Genome: Axes bounded
  'INV-GEN-04',        // Genome: Distribution sum 1.0
  'INV-GEN-05',        // Genome: Similarity symmetric
  'INV-GEN-06',        // Genome: Similarity bounded
  'INV-GEN-07',        // Genome: Self-similarity 1.0
  'INV-GEN-08',        // Genome: Version traced
  'INV-GEN-09',        // Genome: Source traced
  'INV-GEN-10',        // Genome: Read-only
  'INV-GEN-11',        // Genome: Metadata excluded
  'INV-GEN-12',        // Genome: Emotion14 sanctuarized
  'INV-GEN-13',        // Genome: Canonical serialization
  'INV-GEN-14',        // Genome: Float quantization 1e-6
]);
